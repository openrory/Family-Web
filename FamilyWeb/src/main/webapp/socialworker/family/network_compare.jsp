...
function draw_graphs(networkName, chosenPerson, sliderval){ 
  ...
  for (i = 0; i < thisPersonDates.length; i++ )
	{
	  console.dir(thisPersonDates);
	  allNetworkDatesThisPerson = thisPersonDates[sliderval];
	  console.dir(allNetworkDatesThisPerson);
	}
  for ( var dates in allNetworkDatesThisPerson ){
  	 selectedNetworkNodes = allNetworkDatesThisPerson[dates];
